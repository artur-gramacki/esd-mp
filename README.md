...
2. Python scripts for deep learning tasks. All the required scripts are stored in the [sripts](https://github.com/artur-gramacki/esd-mp/tree/main/scripts) directory.
